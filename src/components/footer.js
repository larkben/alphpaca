...
We collect information you provide directly to us when using ALPHpaca, including wallet addresses and transaction data.
...
By accessing and using ALPHpaca, you agree to be bound by these Terms of Service.

2. Description of Service
ALPHpaca provides decentralized finance services on the Alephium blockchain, including but not limited to token creation and management.
...
ALPHpaca is not responsible for any losses incurred while using our services.
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Home', 'Token Creation', 'Wrapped Tokens', 'Profile'].map((item, index) => (
                  <motion.li 
                    key={index}
                    whileHover={{ x: 5 }}
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} ALPHpaca. All rights reserved.
            </p>
